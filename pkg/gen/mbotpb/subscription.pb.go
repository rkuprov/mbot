...
var file_subscription_proto_depIdxs = []int32{
	...
	0,  // 9: mbot.GetSubscriptionsAllResponse.subscriptions:type_name -> mbot.Subscription
	0,  // 10: mbot.GetSubscriptionByCustomerResponse.subscriptions:type_name -> mbot.Subscription
